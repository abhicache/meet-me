  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-orange-500 to-blue-600 text-white">
      <div className="text-center">
        ...
        <a
          href="/"
          className="mt-6 inline-block bg-yellow-500 text-black font-semibold py-3 px-6 rounded-full shadow-lg transition-transform transform hover:scale-105"
        >
          Back to Home
        </a>
      </div>
